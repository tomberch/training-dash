...
def create_app() -> FastAPI:
    ...
    app.get("/api/me")(get_me)
    app.patch("/api/me")(update_me)
    app.get("/api/activities")(list_activities)
    app.get("/api/activities/{activity_id}")(get_activity)
    app.get("/api/activities/{activity_id}/records")(get_activity_records)
    app.get("/api/activities/{activity_id}/wbal")(get_activity_wbal)
    app.get("/api/activities/{activity_id}/same-route")(get_same_route_activities)
    app.get("/api/activities/{activity_id}/compare")(compare_activities)
    app.get("/api/records")(get_records)
    app.post("/api/upload")(upload_activity)
    app.get("/api/jobs/{job_id}")(get_job_status)
    # Admin routes
    app.get("/api/admin/users")(admin_list_users)
    app.post("/api/admin/users")(admin_create_user)
    app.post("/api/admin/users/{user_id}/reset-password")(admin_reset_password)
    app.post("/api/admin/users/{user_id}/sync")(admin_trigger_sync)
    app.get("/api/admin/users/{user_id}/xert-credentials")(admin_get_xert_credentials)
    app.put("/api/admin/users/{user_id}/xert-credentials")(admin_set_xert_credentials)
    app.delete("/api/admin/users/{user_id}/xert-credentials")(admin_delete_xert_credentials)
    # User Xert credentials (self-service)
    app.get("/api/me/xert-credentials")(get_my_xert_credentials)
    app.put("/api/me/xert-credentials")(put_my_xert_credentials)
    app.delete("/api/me/xert-credentials")(delete_my_xert_credentials)
    # User Garmin credentials (self-service)
    app.get("/api/me/garmin-credentials")(get_my_garmin_credentials)
    app.put("/api/me/garmin-credentials")(put_my_garmin_credentials)
    app.post("/api/me/garmin-credentials/mfa")(complete_garmin_mfa)
    app.delete("/api/me/garmin-credentials")(delete_my_garmin_credentials)
    # User thresholds (FTP, LTHR, HRmax)
    app.get("/api/me/thresholds")(get_my_thresholds)
    app.post("/api/me/thresholds")(create_threshold)
    # User zones (power and HR)
    app.get("/api/me/zones")(get_my_zones)
    app.put("/api/me/zones")(update_my_zones)
    # Fitness model
    app.get("/api/fitness")(get_fitness)
    # Performance Management Chart
    app.get("/api/pmc")(get_pmc)
    # Power curve
    app.get("/api/power-curve")(get_power_curve)
    # Notifications
    app.get("/api/me/notifications")(get_notifications)
    app.post("/api/me/notifications/{notification_id}/accept")(accept_notification)
    app.post("/api/me/notifications/{notification_id}/dismiss")(dismiss_notification)
