  ...
  return (
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      <div
        ...
        className="w-full px-3 py-2 border border-border rounded-lg bg-card text-foreground cursor-pointer hover:border-primary/60 focus:outline-none focus:ring-2 focus:ring-ring focus:border-primary transition-colors flex items-center justify-between min-h-[42px]"
      >
        {isOpen ? (
          <input
            ref={inputRef}
      ...
      {isOpen && (
        <div 
          className="absolute z-50 w-full mt-1 bg-card border border-border rounded-lg shadow-lg max-h-80 overflow-auto"
          role="listbox"
          id="activity-listbox"
        >
          {loading ? (
